	...
	pinnedRepos: [
		{
			name: "portfolio-v2",
			description:
				"Performance-first WebGL + GSAP portfolio. The site IS the case study.",
			stargazerCount: 47,
		...
		},
		{
			...
			description:
				"Collection of GLSL fragment shaders — noise, distortion, particles.",
			stargazerCount: 23,
		...
		},
		{
			name: "mono-cms",
			description:
				"Minimal headless CMS with real-time preview and webhook support.",
			stargazerCount: 89,
			primaryLanguage: { name: "TypeScript", color: "#3178c6" },
		...
		},
		{
			name: "scroll-engine",
			description:
				"Lightweight scroll animation library built on IntersectionObserver.",
			stargazerCount: 31,
