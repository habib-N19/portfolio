...
export const blogPosts: BlogPost[] = [
  {
    ...
    date: "May 2026",
    readTime: "8 min",
    excerpt: "How a fixed canvas, three uniforms, and a particle field create atmosphere without stealing focus from the content.",
  ...
  },
  {
    ...
    date: "Apr 2026",
    readTime: "5 min",
    excerpt: "Character-level reveals feel magical when timed right and nauseating when timed wrong. Here's where the line is.",
  ...
  },
  {
    ...
    date: "Mar 2026",
    readTime: "6 min",
    excerpt: "A framework decision rationale — what I gained with Vite + React, what I gave up, and whether I'd do it again.",
  ...
  },
  {
    ...
    date: "Feb 2026",
    readTime: "7 min",
    excerpt: "Most custom cursors are decorative. This one communicates — play icons on video, arrows on external links, text carets on selectable content.",
    imageUrl: "https://images.unsplash.com/photo-1550439062-609e1531270e?w=600&h=400&fit=crop",
  ...
  },
  {
    ...
    date: "Jan 2026",
    readTime: "4 min",
    excerpt: "Three projects that never made it to production. What went wrong, what I learned, and why showing failure builds more trust than hiding it.",
